...
<body class="container-fluid">
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav">
			...
			<li class="active"><a href="getAllTasks">Task List</a></li>
		...
		<div id="page-wrapper">
			...
			<div class="panel-body" style="margin-top: 50px;">
				...
				<form class="form-control" style="border: none;"
					action="<%=request.getContextPath()%>/getAllUsers">
					<div class="row">
						<div class="col-md-2">
							Search by:
							<div class="col-md-10">
									...
									<c:forEach items="${itemList.pageList}" var="item">
										<tr>
											...
											<th><a class="text-muted"
												href="<%=request.getContextPath()%>/editUser?id=<c:out value='${item.id}'/>">Edit</a></th>
											<th><a class="text-muted"
												href="<%=request.getContextPath()%>/deleteUser?id=<c:out value='${item.id}'/>">Delete</a></th>
										</tr>
									</c:forEach>
								</tbody>
							</table>
