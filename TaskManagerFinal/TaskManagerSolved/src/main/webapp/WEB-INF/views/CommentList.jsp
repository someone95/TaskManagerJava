		...
		<div id="page-wrapper">
			<div class="panel panel-default">
				<div class="panel-title">
					<h3 align="center" style="font-size: 1.3em;">
						<b>Comments List</b> <br> <b>Comments of: <c:out
								value="${gomna}" />
						</b>
			...
			<div class="panel-body" style="margin-top: 50px;">
				...
				<form class="form-control" style="border: none;"
					action="<%=request.getContextPath()%>/getAllComments">
					...
					<c:if test="${empty itemList.pageList}">
						<h3 align="center">There are no Comments.</h3>
					</c:if>
									...
									<c:forEach items="${itemList.pageList}" var="item">
										<tr>
											...
											<th><a class="text-muted"
												href="<%=request.getContextPath()%>/editComment?id=<c:out value='${item.id}'/>">Edit</a></th>
											<th><a class="text-muted"
												href="<%=request.getContextPath()%>/deleteComment?id=<c:out value='${item.id}'/>">Delete</a></th>
										</tr>
									</c:forEach>
								</tbody>
							</table>
